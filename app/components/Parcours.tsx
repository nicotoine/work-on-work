        ...
        <Reveal variant="scale">
          <div className={styles.badgeWrapper}>
            <div className={styles.badge}>
              ...
              <span className={styles.badgeText}>Psychologue du travail</span>
            </div>
          </div>
        </Reveal>
        ...
        <Reveal variant="flip">
          <div className={styles.card}>
            <p className={styles.paragraph}>
              <strong className={styles.strong}>Psychologue du travail</strong>,
              spécialisée dans les{" "}
              <strong className={styles.strong}>Risques Psychosociaux</strong>{" "}
              et la{" "}
              ...
              ,{" "}
              <strong className={styles.strong}>
                animatrice de groupe d&apos;analyse des pratiques
              </strong>
              ,{" "}
              <strong className={styles.strong}>
                animatrice de codéveloppement professionnel et managérial
              </strong>
              , <strong className={styles.strong}>praticienne EMDR</strong>,{" "}
              <strong className={styles.strong}>
            ...
            <p className={styles.paragraph}>
              ...
              qu&apos;indépendante (diagnostic RPS, accompagnement PSE, groupes
              de paroles, groupes d&apos;analyse des pratiques, enquête
              violences au travail, permanence psychologique sur site, ...) me
              mènent à cerner rapidement les réalités du monde du travail.
            </p>
            ...
            <p className={styles.paragraphLast}>
              ...
              , me permet d&apos;ajuster ma posture et mes accompagnements à la
              spécificité et à la singularité de chaque situation individuelle
              ou collective et aux différents contextes professionnels.
            </p>
          </div>
        </Reveal>
      </div>
