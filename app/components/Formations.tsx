...
const professionnelles = [
  ...
  },
  {
    ...
    items: [
      ...
      "Intervention en cas de crise suicidaire – Réseau Vies 37",
      "Évaluation du potentiel suicidaire – Réseau Vies 37",
  ...
  },
  {
    ...
    items: [
      "Animatrice certifiée groupe codéveloppement professionnel et managérial – Cecodev",
      "Animatrice groupes d\u0027analyse des pratiques – Fédération Française des Psychologues",
