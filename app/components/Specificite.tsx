      ...
      <div className={styles.container}>
        ...
        <div className={styles.grid}>
          <Reveal variant="slide-right">
            ...
            >
              J&apos;interviens à la croisée de la{" "}
              ...
              . Mon approche intégrative allie une rigueur scientifique à des
              méthodes éprouvées et à un accompagnement humaniste, pour soutenir
              les professionnels dans des contextes de tension ou de
